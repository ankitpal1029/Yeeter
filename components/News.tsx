...
export function News() {
  ...
  return (
    <VStack marginLeft={5} align="left">
      ...
      {data ? (
        getData(data).map((id) => <NewsItem key={id} storyId={id} minH={100} />)
      ) : (
        <SkeleBlock />
      )}
    </VStack>
...
function SkeleBlock() {
  return (
    <VStack align="left">
      <Skeleton minH={100} startColor="blue.500" endColor="red.500">
        hi
      </Skeleton>
      <Skeleton minH={100} startColor="blue.500" endColor="purple.500">
        hi
      </Skeleton>
      <Skeleton minH={100} startColor="blue.500" endColor="yellow.500">
        hi
      </Skeleton>
    </VStack>
  );
